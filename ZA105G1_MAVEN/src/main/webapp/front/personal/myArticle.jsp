...
<!-- 搜尋使用者bar -->
	...
	<div class="single">
		...
		店家名稱:<input type="TEXT" id="findStore"  name="store_name" size="45" value="${storeVO.store_name}" readonly style="font-size:22px; font-family: Microsoft YaHei; color:black;"/>
		...
		食記標題:<input type="TEXT" name="article_title" size="45" maxlength="15" value="<%= (articleVO==null)? "" : articleVO.getArticle_title()%>" style="font-size:22px; font-family: Microsoft YaHei; color:black;"/>
		
		食記內容:<textarea class="ckeditor" id="content" name="article_content"></textarea>
