...
public class CompositeQuery {
	...
	private static String get_aCondition_For_Oracle(String columnName, String value) {		
		...
		//用於Number型態
		if ( "tickets_type_no".equals(columnName) || "tickets_total".equals(columnName) || "tickets_quantity".equals(columnName) || "tickets_price".equals(columnName) || "tickets_state".equals(columnName) || "store_no".equals(columnName) ) {
